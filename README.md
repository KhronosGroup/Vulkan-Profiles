...
* **[vkprofiles commande lines reference](./profiles/README.md)**: Command-line guide and options reference for the `vkprofiles` tool (`validate`, `schema`, `convert`, `merge`, `library`, `doc`).
