...
static std::string GetSimulateCapabilitiesLog(SimulateCapabilityFlags flags) {
    ...
    APPEND_IF(SIMULATE_API_VERSION_BIT);
    APPEND_IF(SIMULATE_FEATURES_BIT);
    APPEND_IF(SIMULATE_PROPERTIES_BIT);
    APPEND_IF(SIMULATE_EXTENSIONS_BIT);
    APPEND_IF(SIMULATE_FORMATS_BIT);
...
static std::string GetDebugActionsLog(DebugActionFlags flags) {
    ...
    APPEND_IF(DEBUG_ACTION_FILE_BIT);
    APPEND_IF(DEBUG_ACTION_STDOUT_BIT);
    APPEND_IF(DEBUG_ACTION_OUTPUT_BIT);
    APPEND_IF(DEBUG_ACTION_BREAKPOINT_BIT);
...
static std::string GetDebugReportsLog(DebugActionFlags flags) {
    ...
    APPEND_IF(DEBUG_REPORT_NOTIFICATION_BIT);
    APPEND_IF(DEBUG_REPORT_WARNING_BIT);
    APPEND_IF(DEBUG_REPORT_ERROR_BIT);
    APPEND_IF(DEBUG_REPORT_DEBUG_BIT);
...
static std::string GetFormatFeatureString(VkFormatFeatureFlags flags) {
    ...
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_STORAGE_IMAGE_ATOMIC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_UNIFORM_TEXEL_BUFFER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_ATOMIC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_VERTEX_BUFFER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_BLIT_SRC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_BLIT_DST_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_TRANSFER_SRC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_TRANSFER_DST_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_DISJOINT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG);
    APPEND_IF(VK_FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_FRAGMENT_DENSITY_MAP_BIT_EXT);
    APPEND_IF(VK_FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR);
...
static std::string GetFormatFeature2String(VkFormatFeatureFlagBits2 flags) {
    ...
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_BLIT_SRC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_BLIT_DST_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_DISJOINT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT);
    APPEND_IF(VK_FORMAT_FEATURE_2_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_2_FRAGMENT_DENSITY_MAP_BIT_EXT);
    APPEND_IF(VK_FORMAT_FEATURE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR);
    APPEND_IF(VK_FORMAT_FEATURE_2_LINEAR_COLOR_ATTACHMENT_BIT_NV);
