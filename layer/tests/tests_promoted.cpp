...
TEST_F(layer_promoted, TestVulkan11Features) {
#ifdef VK_VERSION_1_2
    if (!IsVersionSupported(VK_API_VERSION_1_2)) {
        printf("Required API version is not supported on device, skipping test.\n");
        return;
...
TEST_F(layer_promoted, TestVulkan12Properties) {
#ifdef VK_VERSION_1_2
    if (!IsVersionSupported(VK_API_VERSION_1_2)) {
        printf("Required API version is not supported on device, skipping test.\n");
        return;
...
TEST_F(layer_promoted, TestVulkan12Features) {
#ifdef VK_VERSION_1_2
    if (!IsVersionSupported(VK_API_VERSION_1_2)) {
        printf("Required API version is not supported on device, skipping test.\n");
        return;
...
TEST_F(layer_promoted, TestVulkan13Properties) {
...
TEST_F(layer_promoted, TestVulkan13Features) {
#ifdef VK_VERSION_1_2
    if (!IsVersionSupported(VK_API_VERSION_1_3)) {
        printf("Required API version is not supported on device, skipping test.\n");
        return;
