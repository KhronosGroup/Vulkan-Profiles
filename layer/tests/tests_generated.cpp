...
TEST_F(TestsCapabilitiesGenerated, TestDescriptorBufferPropertiesEXT) {
    ...
    if (supported) {
    EXPECT_EQ(descriptor_buffer_properties_profile.imageCaptureReplayDescriptorDataSize, descriptor_buffer_properties_native.imageCaptureReplayDescriptorDataSize);
    }

    if (supported) {
    EXPECT_EQ(descriptor_buffer_properties_profile.imageViewCaptureReplayDescriptorDataSize, descriptor_buffer_properties_native.imageViewCaptureReplayDescriptorDataSize);
    }

    if (supported) {
    EXPECT_EQ(descriptor_buffer_properties_profile.samplerCaptureReplayDescriptorDataSize, descriptor_buffer_properties_native.samplerCaptureReplayDescriptorDataSize);
    }
