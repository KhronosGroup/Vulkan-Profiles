...
TEST(test_profile, VP_KHR_1_2_roadmap_2022_support) { 
    ...
    VkResult result = vpGetPhysicalDeviceProfileSupport(scaffold.physicalDevice, nullptr, &profile, &supported);
...
TEST(test_profile, VP_LUNARG_1_1_desktop_portability_2022_support) {
    ...
    const VpProfileProperties profile{VP_LUNARG_DESKTOP_PORTABILITY_2021_NAME,
...
TEST(test_profile, VP_LUNARG_1_1_desktop_portability_2022_subset_support) {
    ...
    const VpProfileProperties profile{VP_LUNARG_DESKTOP_PORTABILITY_2021_SUBSET_NAME,
