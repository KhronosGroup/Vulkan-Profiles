...
TEST(mocked_api_get_physdev_profile_support, vulkan13_unsupported_extension) {
    ...
    MockDebugMessageCallback cb({
        ...
        "Unsupported feature condition: VkPhysicalDeviceGlobalPriorityQueryFeaturesKHR::globalPriorityQuery == VK_TRUE"
    });
#endif
...
TEST(mocked_api_get_physdev_profile_support, vulkan11_unsupported_format) {
    ...
    vpGetProfileDeviceExtensionProperties(&profile, nullptr, &extensionsCount, nullptr);

    std::vector<VkExtensionProperties> extensions(extensionsCount);
    vpGetProfileDeviceExtensionProperties(&profile, nullptr, &extensionsCount, &extensions[0]);
