...
TEST(mocked_api_get_physdev_profile_support, vulkan10_unsupported_version) {
    ...
    props.properties.limits.maxImageDimensionCube = 8192;
    props.properties.limits.maxImageArrayLayers = 2048;
    props.properties.limits.maxUniformBufferRange = 65536;
    props.properties.limits.bufferImageGranularity = 4096;
    props.properties.limits.maxPerStageDescriptorSamplers = 64;
    props.properties.limits.maxPerStageDescriptorUniformBuffers = 15;
    props.properties.limits.maxPerStageDescriptorStorageBuffers = 30;
    props.properties.limits.maxPerStageDescriptorSampledImages = 200;
    props.properties.limits.maxPerStageDescriptorStorageImages = 16;
    props.properties.limits.maxPerStageResources = 200;
    props.properties.limits.maxDescriptorSetSamplers = 576;
    props.properties.limits.maxDescriptorSetUniformBuffers = 90;
    props.properties.limits.maxDescriptorSetUniformBuffers = 96;
    props.properties.limits.maxDescriptorSetSampledImages = 1800;
    props.properties.limits.maxDescriptorSetStorageImages = 144;
    props.properties.limits.maxFragmentCombinedOutputResources = 16;
    props.properties.limits.maxComputeWorkGroupInvocations = 256;
    props.properties.limits.maxComputeWorkGroupSize[0] = 1024;
    props.properties.limits.maxComputeWorkGroupSize[1] = 1024;
    props.properties.limits.maxComputeWorkGroupSize[2] = 64;
    props.properties.limits.subTexelPrecisionBits = 8;
    props.properties.limits.mipmapPrecisionBits = 6;
    props.properties.limits.maxSamplerLodBias = 14;
    props.properties.limits.pointSizeGranularity = 0.125f;
    props.properties.limits.lineWidthGranularity = 0.5f;
    props.properties.limits.standardSampleLocations = true;
    props.properties.limits.maxColorAttachments = 7;
    */
