...
struct Functions {
    VpFunctions handle = VK_NULL_HANDLE;

    Functions() {
        VpFunctionsCreateInfo createInfo{};
        createInfo.GetInstanceProcAddr = vkGetInstanceProcAddr;
        createInfo.EnumerateInstanceVersion = vkEnumerateInstanceVersion;
        createInfo.EnumerateInstanceExtensionProperties = vkEnumerateInstanceExtensionProperties;
        createInfo.EnumerateDeviceExtensionProperties = vkEnumerateDeviceExtensionProperties;
        createInfo.GetPhysicalDeviceFeatures2 = vkGetPhysicalDeviceFeatures2;
        createInfo.GetPhysicalDeviceProperties2 = vkGetPhysicalDeviceProperties2;
        createInfo.GetPhysicalDeviceFormatProperties2 = vkGetPhysicalDeviceFormatProperties2;
        createInfo.GetPhysicalDeviceQueueFamilyProperties2 = vkGetPhysicalDeviceQueueFamilyProperties2;
        createInfo.CreateInstance = vkCreateInstance;
        createInfo.CreateDevice = vkCreateDevice;

        vpCreateFunctions(&createInfo, nullptr, &handle);
    }
...
TEST(fucntions_object, overrite_with_unsupported_extensions) {
    ...
    VkResult res = vpCreateDevice(
        functions.handle, scaffold->physicalDevice, &profileInfo, nullptr, &device);
...
TEST(api_capabilities_object, get_profiles) {
    ...
    VkResult result0 = vpGetProfiles(functions.handle, &propertyCount, nullptr);
    EXPECT_EQ(VK_SUCCESS, result0);
    EXPECT_TRUE(propertyCount > 1);

    std::vector<VpProfileProperties> properties(propertyCount);
    VkResult result1 = vpGetProfiles(functions.handle, &propertyCount, &properties[0]);
...
TEST(api_capabilities_object, get_profile_fallback) {
    ...
    VkResult result1 = vpGetProfileFallbacks(functions.handle, &profileProperties, &count, &data[0]);
    EXPECT_EQ(VK_SUCCESS, result1);
    EXPECT_EQ(0, count);
}
...
TEST(api_capabilities_object, has_multiple_variants_profile) {
    ...
    VkResult result0 = vpHasMultipleVariantsProfile(functions.handle, &profileProperties, &has_multiple_variants);
    EXPECT_EQ(VK_SUCCESS, result0);
...
TEST(api_capabilities_object, get_profile_device_extension_properties) {
    ...
    VkResult result0 = vpGetProfileDeviceExtensionProperties(
        functions.handle, &profileProperties, nullptr, &propertyCount, nullptr);
    EXPECT_EQ(VK_SUCCESS, result0);
    ...
    VkResult result1 = vpGetProfileDeviceExtensionProperties(
        functions.handle, &profileProperties, nullptr, &propertyCount, &properties[0]);
    EXPECT_EQ(VK_SUCCESS, result1);
    EXPECT_EQ(1, propertyCount);
...
TEST(api_capabilities_object, get_profile_formats) {
    ...
    VkResult result0 = vpGetProfileFormats(functions.handle, &profileProperties, nullptr, &formatCount, nullptr);
    EXPECT_EQ(VK_SUCCESS, result0);
...
TEST(api_capabilities_object, get_profile_properties) {
    ...
    vpGetProfileProperties(functions.handle, &profileProperties, nullptr, &profileProperties2);
...
TEST(api_capabilities_object, get_profile_features) {
    ...
    vpGetProfileFeatures(functions.handle, &profileProperties, nullptr, &deviceFeatures2);
...
TEST(api_capabilities_object, get_profile_feature_structure_types) {
    ...
    VkResult result0 = vpGetProfileFeatureStructureTypes(
        functions.handle, &profileProperties, nullptr, &featureCount, nullptr);
    EXPECT_EQ(VK_SUCCESS, result0);
    ...
    VkResult result1 = vpGetProfileFeatureStructureTypes(
        functions.handle, &profileProperties, nullptr, &featureCount, &features[0]);
    EXPECT_EQ(VK_SUCCESS, result1);
    EXPECT_EQ(5, featureCount);
