...
#define VP_ANDROID_ANGLE_ES31_NAME "VP_ANDROID_angle_es31"
#define VP_ANDROID_ANGLE_ES31_SPEC_VERSION 1
#define VP_ANDROID_ANGLE_ES31_MIN_API_VERSION VK_MAKE_VERSION(1, 1, 131)
