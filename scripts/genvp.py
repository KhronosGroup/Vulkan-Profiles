...
class VulkanRegistry():
    ...
    def applyWorkarounds(self):
        ...
        if 'VkPhysicalDeviceVulkan11Properties' in self.structs:
            self.structs['VkPhysicalDeviceVulkan11Properties'].members['deviceUUID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan11Properties'].members['driverUUID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan11Properties'].members['deviceLUID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan11Properties'].members['deviceNodeMask'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan11Properties'].members['deviceLUIDValid'].limittype = 'identifier'
        ...
        if 'VkPhysicalDeviceVulkan12Properties' in self.structs:
            self.structs['VkPhysicalDeviceVulkan12Properties'].members['driverID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan12Properties'].members['driverName'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan12Properties'].members['driverInfo'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceVulkan12Properties'].members['conformanceVersion'].limittype = 'identifier'
        ...
        if 'VkPhysicalDeviceProperties' in self.structs:
            self.structs['VkPhysicalDeviceProperties'].members['apiVersion'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceProperties'].members['driverVersion'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceProperties'].members['vendorID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceProperties'].members['deviceID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceProperties'].members['deviceType'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceProperties'].members['deviceName'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceProperties'].members['pipelineCacheUUID'].limittype = 'identifier'

        if 'VkPhysicalDeviceToolProperties' in self.structs:
            self.structs['VkPhysicalDeviceToolProperties'].members['name'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceToolProperties'].members['version'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceToolProperties'].members['purposes'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceToolProperties'].members['description'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceToolProperties'].members['layer'].limittype = 'identifier'

        if 'VkPhysicalDeviceDriverProperties' in self.structs:
            self.structs['VkPhysicalDeviceDriverProperties'].members['driverID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDriverProperties'].members['driverName'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDriverProperties'].members['driverInfo'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDriverProperties'].members['conformanceVersion'].limittype = 'identifier'

        if 'VkPhysicalDeviceIDProperties' in self.structs:
            self.structs['VkPhysicalDeviceIDProperties'].members['deviceUUID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceIDProperties'].members['driverUUID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceIDProperties'].members['deviceLUID'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceIDProperties'].members['deviceNodeMask'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceIDProperties'].members['deviceLUIDValid'].limittype = 'identifier'
        ...
        if 'VkPhysicalDevicePCIBusInfoPropertiesEXT' in self.structs:
            self.structs['VkPhysicalDevicePCIBusInfoPropertiesEXT'].members['pciDomain'].limittype = 'identifier'
            self.structs['VkPhysicalDevicePCIBusInfoPropertiesEXT'].members['pciBus'].limittype = 'identifier'
            self.structs['VkPhysicalDevicePCIBusInfoPropertiesEXT'].members['pciDevice'].limittype = 'identifier'
            self.structs['VkPhysicalDevicePCIBusInfoPropertiesEXT'].members['pciFunction'].limittype = 'identifier'

        if 'VkPhysicalDeviceDrmPropertiesEXT' in self.structs:
            self.structs['VkPhysicalDeviceDrmPropertiesEXT'].members['hasPrimary'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDrmPropertiesEXT'].members['hasRender'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDrmPropertiesEXT'].members['primaryMajor'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDrmPropertiesEXT'].members['primaryMinor'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDrmPropertiesEXT'].members['renderMajor'].limittype = 'identifier'
            self.structs['VkPhysicalDeviceDrmPropertiesEXT'].members['renderMinor'].limittype = 'identifier'
    ...
    def gen_structCompare(self, fmt, structDef, var, values, parentLimittype = None):
        ...
        for member, value in sorted(values.items()):
            if member in structDef.members:
                ...
                elif limittype is None or limittype == 'noauto' or limittype == 'exact' or limittype == 'identifier' or limittype == 'struct':
                    # Compare everything else with equality
                    comparePredFmt = '{0} == {1}'
                else:
